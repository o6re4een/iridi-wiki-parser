...
<details>
<summary>#### см\. Настройки области диаграммы</summary>
<div>

![123](/img/IRidium_studio_2019_Trends/Studio2019_Server_Trend_Settings_1.png)

**Chart area\.** Заливка в области диаграммы и области осей 

- **Axis area** – заливка в области осей, рамка вокруг осей 

    - **Fill** \- заливка 

        - *Color* \- цвет заливки
        - *Opacity* \- общая непрозрачность области осей
    - **Border** \- рамка вокруг осей 

        - *Color* \- цвет рамки
        - *Width* \- толщина рамки
- **Chart area** – заливка в области диаграммы 

    - **Fill** \- заливка 

        - *Color* \- цвет заливки
        - *Opacity* \- общая непрозрачность области диаграммы

![123](/img/IRidium_studio_2019_Trends/Studio2019_Server_Trend_Settings_2.png)

**Horizontal axis \(time\)\.** Горизонтальная ось \(время\): линия, засечки, доп\. засечки, текст на засечках, заголовок 

- **Axis line and time scale** – линия оси и основные засечки 

    - Color – цвет линии оси и засечек
    - Mark size – высота засечек
- **Time on scale marks** – отметки времени на засечках 

    - Show – показывать отметки времени на засечках
    - Template – формат отображения времени на засечках
    - Font \- настройки шрифта и цвет текста на засечках
    - Indent from axis – отступ текста от линии оси, зависит от от высоты засечек и размера шрифта
- **Additional marks between scale marks** – дополнительные засечки 

    - Color – цвет дополнительных засечек
    - Mark size – высота дополнительных засечек
- **Axis heading** – заголовок оси 

    - Show – показывать заголовок
    - Heading – текст заголовка
    - Font \- настройки шрифта и цвет текста заголовка

![123](/img/IRidium_studio_2019_Trends/Studio2019_Server_Trend_Settings_3.png)

**Vertical axis \(data\)\.** Вертикальная ось \(данные\): линия, засечки, доп\. засечки, текст на засечках, заголовок 

- **Axis line and time scale** – линия оси и основные засечки 

    - Color – цвет линии оси и засечек
    - Mark size – высота засечек
- **Time on scale marks** – значения на засечках 

    - Show – показывать значения на засечках
    - Template – формат отображения значений на засечках
    - Font \- настройки шрифта и цвет текста на засечках
    - Indent from axis – отступ текста от линии оси, зависит от от высоты засечек и размера шрифта
- **Additional marks between scale marks** – дополнительные засечки 
...
![123](/img/IRidium_studio_2019_Trends/Studio2019_Server_Trend_Settings_4.png)

**Cursor in chart area\.** Курсор в области диаграммы \(для Windows\) 

- Show – показывать курсор
- Color – цвет курсора
- Hide in \(мс\) – скрывать после указанного времени неподвижности
